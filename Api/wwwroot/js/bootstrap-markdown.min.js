	...
	Markdown.prototype = {
		constructor: Markdown, __alterButtons: function (name, alter) {
				...
				for (y = 0; y < btnGroups.length; y++) {
					...
					for (z = 0; z < buttons.length; z++) {
						var button = buttons[z], buttonContainer, buttonIconContainer,
							buttonHandler = ns + "-" + button.name, buttonIcon = this.__getIcon(button.icon),
			...
			var target = $(e.currentTarget), handler = this.$handler, callback = this.$callback,
				handlerName = target.attr("data-handler"), callbackIndex = handler.indexOf(handlerName),
			...
			var instance = this, textarea, ns = this.$ns, container = this.$element,
				...
				editable = this.$editable, handler = this.$handler, callback = this.$callback, options = this.$options,
				editor = $("<div/>", {
			...
			var options = this.$options, container = this.$textarea, afterContainer = container.next(),
